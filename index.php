...
<html lang="es">
	...
	<body>
	    ...
	    <main>
	    	...
	    	<section class="container-fluid index_container index_container--seccion2" id="sec-2">
	    		<form method="post">
		    		<div class="row">
	    	...
	    	<section class="container-fluid index_container index_container--seccion4" id="sec-4">
	    		<div class="row">
	    			<div class="col-md-6 col-12">
	    				<form method="post">
	    					<div class="row">
	    						<div class="col-md-7 .col-12">
	    							<p>Comunicate con<br><b>Nosotros</b></p>
	    						</div>
	    						<div class="col-6">
	    						...
	    						<div class="col-6">
	    							<input type="text" name="phone2" placeholder="TELEFONO">
	    						</div>
	    						<div class="col-6">
